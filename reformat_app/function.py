...
class collect_data:
    ...
    def extract_lds_data(self, i:int, line:any) -> dict:
    ...
    def extract_bos_data(self, i:int, workbook:any) -> dict:
    ...
    def extract_cum_data(self, i:int, workbook:any) -> dict:
    ...
    def extract_ica_data(self, i:int, workbook:any) -> dict:
    ...
    def extract_iic_data(self, i:int, workbook:any) -> dict:
    ...
    def extract_lmt_data(self, i:int, workbook:any) -> dict:
    ...
    def extract_moc_data(self, i:int, workbook:any) -> dict:
